...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Manage multiple AWS credential sets securely.}
  spec.description   = %q{Securely save, store, and switch between multple sets of AWS keys and secrets.}
